 ...
 * Obstacles are persistent map objects that players can remove by spending resources
 */
public class Obstacle {
    ...
    private long removeStartTime; // Timestamp when the obstacle was last modified or removed
    ...
    public void setRemoveStartTime(long removeStartTime) {
